...
# G0-001-A — Verify source-4e69049.zip and velqu-4e69049.bundle against SOURCE-COMMIT.txt and the supplied SHA256SUMS manifest

## Atomic goal

Verify source-4e69049.zip and velqu-4e69049.bundle against SOURCE-COMMIT.txt and the supplied SHA256SUMS manifest.
...
5. Implement exactly this deliverable: Verify source-4e69049.zip and velqu-4e69049.bundle against SOURCE-COMMIT.txt and the supplied SHA256SUMS manifest.
...
```text
g0-001-a: verify source 4e69049 zip and velqu 4e69049 bundle against s
```
