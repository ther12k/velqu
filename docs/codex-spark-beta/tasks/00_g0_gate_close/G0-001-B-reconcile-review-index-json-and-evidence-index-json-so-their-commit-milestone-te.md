...
# G0-001-B — Reconcile REVIEW_INDEX.json and EVIDENCE_INDEX.json so their commit, milestone, test counts, benchmark protocol, and open items describe the actual release commit rather than e2b379d

## Atomic goal

Reconcile REVIEW_INDEX.json and EVIDENCE_INDEX.json so their commit, milestone, test counts, benchmark protocol, and open items describe the actual release commit rather than e2b379d.
...
5. Implement exactly this deliverable: Reconcile REVIEW_INDEX.json and EVIDENCE_INDEX.json so their commit, milestone, test counts, benchmark protocol, and open items describe the actual release commit rather than e2b379d.
...
```text
g0-001-b: reconcile review index json and evidence index json so their
```
