...
# G0-003-C — Implement SerializedRouter semantic verification: non-empty root, unique static edges, exact method masks, route method/path agreement, reachability, capture counts, and valid RouteId references

## Atomic goal

Implement SerializedRouter semantic verification: non-empty root, unique static edges, exact method masks, route method/path agreement, reachability, capture counts, and valid RouteId references.
...
5. Implement exactly this deliverable: Implement SerializedRouter semantic verification: non-empty root, unique static edges, exact method masks, route method/path agreement, reachability, capture counts, and valid RouteId references.
...
```text
g0-003-c: implement serializedrouter semantic verification non empty r
```
