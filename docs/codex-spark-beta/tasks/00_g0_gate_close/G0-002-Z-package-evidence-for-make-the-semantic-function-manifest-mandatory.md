...
# G0-002-Z — Package evidence for Make the semantic function manifest mandatory

## Atomic goal

Create source-backed evidence and handoff for parent task G0-002; update status only if verification passed.
...
- `G0-002-V` — `tasks/00_g0_gate_close/G0-002-V-verify-make-the-semantic-function-manifest-mandatory.md`
...
```text
g0-002-z: package evidence for make the semantic function manifest man
```
