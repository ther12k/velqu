...
# G0-008-D — Capture allocation/startup profiles, including the 10,000-route JSON-pack parsing cost

## Atomic goal

Capture allocation/startup profiles, including the 10,000-route JSON-pack parsing cost.
...
5. Implement exactly this deliverable: Capture allocation/startup profiles, including the 10,000-route JSON-pack parsing cost.
...
```text
g0-008-d: capture allocation startup profiles including the 10 000 rou
```
