...
# G0-004-B — Keep Router::build only in the reference matcher/compiler tests and explicit legacy adapter

## Atomic goal

Keep Router::build only in the reference matcher/compiler tests and explicit legacy adapter.
...
5. Implement exactly this deliverable: Keep Router::build only in the reference matcher/compiler tests and explicit legacy adapter.
...
```text
g0-004-b: keep router build only in the reference matcher compiler tes
```
