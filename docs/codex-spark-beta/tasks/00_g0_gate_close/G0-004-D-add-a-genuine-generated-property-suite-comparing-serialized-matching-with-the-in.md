...
# G0-004-D — Add a genuine generated property suite comparing serialized matching with the independent reference matcher across methods, static/param/wildcard paths, parameter names, 404, 405, and Allow

## Atomic goal

Add a genuine generated property suite comparing serialized matching with the independent reference matcher across methods, static/param/wildcard paths, parameter names, 404, 405, and Allow.
...
5. Implement exactly this deliverable: Add a genuine generated property suite comparing serialized matching with the independent reference matcher across methods, static/param/wildcard paths, parameter names, 404, 405, and Allow.
...
```text
g0-004-d: add a genuine generated property suite comparing serialized
```
