...
# G0-009-C — Extend the production/beta ledger validator to verify evidence paths, test names, dependency status, commit format, and artifact hashes for PASS tasks

## Atomic goal

Extend the production/beta ledger validator to verify evidence paths, test names, dependency status, commit format, and artifact hashes for PASS tasks.
...
5. Implement exactly this deliverable: Extend the production/beta ledger validator to verify evidence paths, test names, dependency status, commit format, and artifact hashes for PASS tasks.
...
```text
g0-009-c: extend the production beta ledger validator to verify eviden
```
