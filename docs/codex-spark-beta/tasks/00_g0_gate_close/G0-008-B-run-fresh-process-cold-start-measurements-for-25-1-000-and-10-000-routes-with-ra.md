...
# G0-008-B — Run fresh-process cold-start measurements for 25, 1,000, and 10,000 routes with randomized order and the required sample count

## Atomic goal

Run fresh-process cold-start measurements for 25, 1,000, and 10,000 routes with randomized order and the required sample count.
...
5. Implement exactly this deliverable: Run fresh-process cold-start measurements for 25, 1,000, and 10,000 routes with randomized order and the required sample count.
...
```text
g0-008-b: run fresh process cold start measurements for 25 1 000 and 1
```
