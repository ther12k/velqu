...
# G0-001-D — Capture compiler, Rust, Bun, QuickJS-NG, rquickjs, OS, CPU, load-generator, and benchmark-tool versions in one current environment report

## Atomic goal

Capture compiler, Rust, Bun, QuickJS-NG, rquickjs, OS, CPU, load-generator, and benchmark-tool versions in one current environment report.
...
5. Implement exactly this deliverable: Capture compiler, Rust, Bun, QuickJS-NG, rquickjs, OS, CPU, load-generator, and benchmark-tool versions in one current environment report.
...
```text
g0-001-d: capture compiler rust bun quickjs ng rquickjs os cpu load ge
```
