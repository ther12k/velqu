...
# G0-002-C — Validate every numeric vector entry by exact index, key, kind, and callability

## Atomic goal

Validate every numeric vector entry by exact index, key, kind, and callability.
...
5. Implement exactly this deliverable: Validate every numeric vector entry by exact index, key, kind, and callability.
...
```text
g0-002-c: validate every numeric vector entry by exact index key kind
```
