...
# G0-005-C — Require a dense complete SchemaId manifest and use SchemaId for all request validation lookups

## Atomic goal

Require a dense complete SchemaId manifest and use SchemaId for all request validation lookups.
...
5. Implement exactly this deliverable: Require a dense complete SchemaId manifest and use SchemaId for all request validation lookups.
...
```text
g0-005-c: require a dense complete schemaid manifest and use schemaid
```
