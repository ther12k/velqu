...
# G0-006-D — Add stability/change tests for internal reorder, handler rename, serializer change, header/body/content-type/security changes, and arbitrary supplied hashes

## Atomic goal

Add stability/change tests for internal reorder, handler rename, serializer change, header/body/content-type/security changes, and arbitrary supplied hashes.
...
5. Implement exactly this deliverable: Add stability/change tests for internal reorder, handler rename, serializer change, header/body/content-type/security changes, and arbitrary supplied hashes.
...
```text
g0-006-d: add stability change tests for internal reorder handler rena
```
