...
# G0-005-B — Introduce a dense PolicyPlan manifest so PolicyId resolves to the exact pre-verified policy HandlerId

## Atomic goal

Introduce a dense PolicyPlan manifest so PolicyId resolves to the exact pre-verified policy HandlerId.
...
5. Implement exactly this deliverable: Introduce a dense PolicyPlan manifest so PolicyId resolves to the exact pre-verified policy HandlerId.
...
```text
g0-005-b: introduce a dense policyplan manifest so policyid resolves t
```
