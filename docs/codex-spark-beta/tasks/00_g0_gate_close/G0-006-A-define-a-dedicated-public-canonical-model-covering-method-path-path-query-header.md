...
# G0-006-A — Define a dedicated public canonical model covering method, path, path/query/header/body schemas, coercion, content types, statuses, response bodies, public problems, security, and deprecation metadata

## Atomic goal

Define a dedicated public canonical model covering method, path, path/query/header/body schemas, coercion, content types, statuses, response bodies, public problems, security, and deprecation metadata.
...
5. Implement exactly this deliverable: Define a dedicated public canonical model covering method, path, path/query/header/body schemas, coercion, content types, statuses, response bodies, public problems, security, and deprecation metadata.
...
```text
g0-006-a: define a dedicated public canonical model covering method pa
```
...
- Verification:
  - `cargo test -p q-pack`
  - `public_contract_hash_is_stable_when_function_ids_are_reordered`
  - `header_contract_change_changes_public_contract_hash`
- Evidence artifacts:
  - `REVIEW_INDEX.json`
  - `EVIDENCE_INDEX.json`
