...
# G0-003-B — Recompute and verify the execution graph hash inside QPack::verify before ready

## Atomic goal

Recompute and verify the execution graph hash inside QPack::verify before ready.
...
5. Implement exactly this deliverable: Recompute and verify the execution graph hash inside QPack::verify before ready.
...
```text
g0-003-b: recompute and verify the execution graph hash inside qpack v
```
