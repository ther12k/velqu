...
# M28-010-B — Create deterministic DNS/TLS/redirect/slow/body fixtures
...
5. Implement exactly this deliverable: Create deterministic DNS/TLS/redirect/slow/body fixtures.
