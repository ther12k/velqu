...
# M26-006-D — Keep unsigned local development supported with explicit policy
...
5. Implement exactly this deliverable: Keep unsigned local development supported with explicit policy.
...
```text
m26-006-d: keep unsigned local development supported with explicit poli
```
