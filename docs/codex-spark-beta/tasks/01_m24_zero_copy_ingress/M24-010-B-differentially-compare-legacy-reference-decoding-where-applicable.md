...
# M24-010-B — Differentially compare legacy/reference decoding where applicable
...
5. Implement exactly this deliverable: Differentially compare legacy/reference decoding where applicable.
...
```text
m24-010-b: differentially compare legacy reference decoding where appli
```
