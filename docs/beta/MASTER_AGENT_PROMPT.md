...
Candidate ZIP:     generated by scripts/release-packet after clean HEAD
Candidate bundle:  generated by scripts/release-packet after clean HEAD
Candidate hashes:  recorded in packet-local SHA256SUMS.txt
Starting status:   M23R2 implementation checkpoint; M23 production gate remains open
