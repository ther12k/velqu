...
# M27-001-C — Define native operation owner/deadline state
...
5. Implement exactly this deliverable: Define native operation owner/deadline state.
...
- `docs/beta/program/STATUS.md`, `indexes/TASK_INDEX.md` — this
  packet PASS.
