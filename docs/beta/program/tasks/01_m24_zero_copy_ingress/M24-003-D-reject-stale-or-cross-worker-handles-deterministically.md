...
- Changed files:
  ...
  - `docs/beta/program/tasks/01_m24_zero_copy_ingress/M24-003-D-reject-stale-or-cross-worker-handles-deterministically.md`, `docs/beta/program/STATUS.md`, `docs/beta/program/indexes/TASK_INDEX.md`
