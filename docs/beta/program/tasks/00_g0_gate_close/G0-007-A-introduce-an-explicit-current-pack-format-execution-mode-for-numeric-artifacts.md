...
# G0-007-A — Introduce an explicit current pack format/execution mode for numeric artifacts

## Atomic goal

Introduce an explicit current pack format/execution mode for numeric artifacts.
...
5. Implement exactly this deliverable: Introduce an explicit current pack format/execution mode for numeric artifacts.
...
```text
g0-007-a: introduce an explicit current pack format execution mode for
```
