...
# G0-007-C — Require function, policy, schema, RoutePlan, and serialized-router manifests in numeric mode

## Atomic goal

Require function, policy, schema, RoutePlan, and serialized-router manifests in numeric mode.
...
5. Implement exactly this deliverable: Require function, policy, schema, RoutePlan, and serialized-router manifests in numeric mode.
...
```text
g0-007-c: require function policy schema routeplan and serialized rout
```
