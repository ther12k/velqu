...
# G0-005-A — Make Router match results carry RouteId and use RouteId to index a dense verified RoutePlan vector

## Atomic goal

Make Router match results carry RouteId and use RouteId to index a dense verified RoutePlan vector.
...
5. Implement exactly this deliverable: Make Router match results carry RouteId and use RouteId to index a dense verified RoutePlan vector.
...
```text
g0-005-a: make router match results carry routeid and use routeid to i
```
