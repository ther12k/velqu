...
# G0-007-D — Isolate v1 legacy loading in a versioned compatibility adapter and reject mixed-mode artifacts

## Atomic goal

Isolate v1 legacy loading in a versioned compatibility adapter and reject mixed-mode artifacts.
...
5. Implement exactly this deliverable: Isolate v1 legacy loading in a versioned compatibility adapter and reject mixed-mode artifacts.
...
```text
g0-007-d: isolate v1 legacy loading in a versioned compatibility adapt
```
