...
Create source-backed evidence and handoff for parent task BETA-016; update status only if verification passed.
...
- `BETA-016-V` — `tasks/08_public_beta/BETA-016-V-verify-run-external-clean-install-and-tutorial-verification.md`
...
```text
beta-016-z: package evidence for run external clean install and tutorial
```
