...
7. [Limits and non-goals](LIMITS-AND-NON-GOALS.md)
8. [Master agent prompt](MASTER_AGENT_PROMPT.md)
9. [Current state and baseline](00_CURRENT_BASELINE.md)
10. [Beta definition](01_BETA_DEFINITION.md)
11. [Scope matrix](02_SCOPE_MATRIX.md)
12. [Critical path](03_CRITICAL_PATH.md)
13. [Task ledger](04_TASK_LEDGER.md)
14. [Dependency map](05_DEPENDENCY_MAP.md)
