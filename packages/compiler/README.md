...
Static route extraction, deterministic QPack emission, contract/OpenAPI/lock output, and the `browser-wasm` target. Never executes application code. Requires Bun 1.4+.
