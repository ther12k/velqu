...
1. Read [`docs/browser-wasm/MASTER_PLAN.md`](docs/browser-wasm/MASTER_PLAN.md).
2. Resolve [`OWNER_DECISIONS.md`](docs/browser-wasm/OWNER_DECISIONS.md).
3. Review [`TASK_INDEX.md`](docs/browser-wasm/TASK_INDEX.md) and [`DEPENDENCY_GRAPH.md`](docs/browser-wasm/DEPENDENCY_GRAPH.md).
...
- one combined [`ALL_ISSUES.md`](docs/browser-wasm/ALL_ISSUES.md) plus standalone issue files;
